...
exports.claimControllers = void 0;
const http_status_1 = __importDefault(require("http-status"));
const catchAsync_1 = __importDefault(require("../../../shared/catchAsync"));
const sendResponse_1 = __importDefault(require("../../../shared/sendResponse"));
const claim_services_1 = require("./claim.services");
...
const createClaim = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield claim_services_1.claimServices.createClaim(req.body, userId);
...
const getAllClaim = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield claim_services_1.claimServices.getAllClaim();
    (0, sendResponse_1.default)(res, {
        success: true,
...
const updateClaimStatus = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield claim_services_1.claimServices.updateClaimStatus(req.body, claimId);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
